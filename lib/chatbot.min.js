var{keys:aC}=Object,{assign:a}=Object,e='<span class="material-symbols-outlined upload-file" id="attach_file">attach_file</span><input hidden type="file" id="file-upload">';var b=`<style>
  ...
  </div>`;function g(C){this.apiKey=C}a(g.prototype,{activateChatBot(){var A=document.createElement('iframe'),_=this.apiKey?`?api_key=${this.apiKey}"`:'';A.setAttribute('style',c);A.id='chat-bot-frame';A.srcdoc=`<head>${b}<script src="https://cdn.jsdelivr.net/gh/amarshilpakar/chatbot/lib/emoji-picker.min.js"></script><script src="https://cdn.jsdelivr.net/gh/amarshilpakar/chatbot/lib/chatbot-core.min.js${_}"></script><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" /><link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@48,400,1,0" /></head><button class="chat-bot-activate"><span class="material-symbols-rounded">mode_comment</span><span class="material-symbols-outlined">close</span></button>${f}`;document.body.append(A)},removeChatBot(){var B=document.getElementById('chat-bot-frame');B.remove()}});var h=new g('', '');window.activateChatWindow=()=>h.activateChatBot();window.removeChatWindow=()=>h.removeChatBot();window.updateChatBoxColor=_a=>{var _b=aC(_a);for(const D of _b)document.getElementById('chat-bot-frame').contentWindow.document.documentElement.style.setProperty(`--${D}`,_a[D])};(()=>window.addEventListener('DOMContentLoaded',()=>{var _A=document.getElementsByTagName('script');for(const E of _A){var _B=E.src;if(_B.includes('chatbot.min.js')){var _c=new URL(_B);var _d=_c.searchParams.get('mode');_d=='auto'&&h.activateChatBot()}}}))();
