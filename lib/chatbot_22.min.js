var{keys:aE}=Object,{assign:a}=Object,e='<span class="material-symbols-outlined upload-file" id="attach_file">attach_file</span><input hidden type="file" id="file-upload">',g='@media (max-width: 600px){#chat-bot-frame{top:0px !important;bottom:0px !important;right:0px !important;bottom:0px !important;max-height: 100vh !important;height: 100vh !important;width: 100vw !important;max-width: 100vw !important}}';var b=`<style>
  ...
  </div>`;function h(_a){this.apiKey=_a}a(h.prototype,{activateChatBot(){var A=document.createElement('iframe'),_=document.createElement('style'),B=this.apiKey?`?api_key=${this.apiKey}"`:'';_.innerText=g;_.id='iframe-media';A.setAttribute('style',c);A.id='chat-bot-frame';A.srcdoc=`<head>${b}<script src="https://cdn.jsdelivr.net/gh/amarshilpakar/chatbot/lib/emoji-picker.min.js"></script><script src="https://cdn.jsdelivr.net/gh/amarshilpakar/chatbot/lib/chatbot-core.min_2.js${B}"></script><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" /><link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@48,400,1,0" /></head><button class="chat-bot-activate"><span class="material-symbols-rounded">mode_comment</span><span class="material-symbols-outlined">close</span></button>${f}`;document.body.append(A);document.head.append(_)},removeChatBot(){var C=document.getElementById('chat-bot-frame'),_b=document.getElementById('iframe-media');C.remove();_b.remove()}});var i=new h('', '');window.activateChatWindow=()=>i.activateChatBot();window.removeChatWindow=()=>i.removeChatBot();window.updateChatBoxColor=D=>{var _B=aE(D);for(const _A of _B)document.getElementById('chat-bot-frame').contentWindow.document.documentElement.style.setProperty(`--${_A}`,D[_A])};(()=>window.addEventListener('DOMContentLoaded',()=>{var E=document.getElementsByTagName('script');for(const aB of E){var aA=aB.src;if(aA.includes('chatbot.min.js')){var _c=new URL(aA);var _d=_c.searchParams.get('mode');_d=='auto'&&i.activateChatBot()}}}))();
